...
def main():
    ...
    prices, future_price = data_formatter.format_attributes(df['Close'], 30, 3)

    nueral_net(input, label)
    # Split data into training and test set. Allow for the possibility that the test set is 0 length
    # Normilize the dats
    # Do ML
